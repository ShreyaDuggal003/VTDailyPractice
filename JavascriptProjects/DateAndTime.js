...
let myDate1 = new Date(2025, 1, 28); //days and months in javascript starts from 0 thus here it is 1st jan, 2025 in single digits
console.log(myDate1.toLocaleString());

let myDate2 = new Date(2027, 0, 31, 15, 23, 62); //to add both date and time....javascript automatically handles the time
...
let date1 = new Date("01/02/2025");
console.log(date1.getTime()); //will give given date timestamp
